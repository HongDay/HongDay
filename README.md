<div>
  ...
  ## 👀 About Me
  #### :raising_hand: 클라우드 / 백엔드 공부중인 개발자 홍대의 입니다!<br/>
  #### :mortar_board: UNIST 컴퓨터공학과 (2020.03 ~ 2026.07)
  #### 🔥 `클라우드 엔지니어`, `백엔드 개발자`, `AI/ML 사이언티스트`<br/>
  <br/>
  <br/>
  ...
  ## My values
🦻 타인의 사고방식 속으로 들어가보는 것을 좋아합니다 <br />
😎 기초부터 꾸준히, 빈틈없이 성장하기 위해 노력합니다 <br />
🤔 문제 해결을 위해 다양한 방식을 탐색하고 비교하는 것을 좋아합니다 <br />
👌 이미 공부했던 내용에 대한 문제점을 해결하지 못하는 것을 싫어합니다 <br />
